...
const Footer = () => {
  return (
    ...
    <footer className="text-center relative md:pb-10 pb-10 bg-gray-900 border-t-2 border-gray-400 text-white">
  <div className="grid grid-cols-1 md:grid-cols-3 md:gap-5 md:justify-start">
    <div className="text-gray-300 relative h-16 w-16 rounded-full flex md:justify-center md:items-center justify-center items-center m-auto md:ml-10">
      <Image
        fill
    ...
    <div className="flex flex-col md:justify-center py-8 md:items-center justify-center items-center md:mr-5">
      ...
      <ul className="grid grid-cols-3 md:hidden mt-8">
        ...
        <Link href="/Experience" prefetch={false}>
          <li className="p-4 text-sm">Experience</li>
        </Link>
    ...
    <ul className="hidden md:grid-cols-2 md:grid mt-3">
      <Link href="/#intro" prefetch={false}>
        <li className="mx-3 text-sm uppercase hover:bg-gray-500 rounded-full py-1 px-2">Home</li>
      </Link>
      <Link href="/#about" prefetch={false}>
        <li className="mx-3 text-sm uppercase hover:bg-gray-500 rounded-full py-1 px-2">About</li>
      </Link>
      <Link href="/#skill" prefetch={false}>
        <li className="mx-3 text-sm uppercase hover:bg-gray-500 rounded-full py-1 px-2">Skills</li>
      </Link>
      <Link href="/Experience" prefetch={false}>
        <li className="mx-3 text-sm uppercase hover:bg-gray-500 rounded-full py-1 px-2">Experience</li>
      </Link>
      <Link href="/Project" prefetch={false}>
        <li className="mx-3 text-sm uppercase hover:bg-gray-500 rounded-full py-1 px-2">Projects</li>
      </Link>
      <Link href="/#contact" prefetch={false}>
        <li className="mx-3 text-sm uppercase hover:bg-gray-500 rounded-full py-1 px-2">Contact</li>
      </Link>
    </ul>
  </div>
  <div className="text-white w-full absolute bottom-0 py-4">
    &copy; George Georgiou Hadjigeorgiou
  </div>
</footer>
    ...
    //       <Link href="/#intro" prefetch={false}>
    //         <li className="mx-3 text-small uppercase hover:bg-gray-500 rounded-full py-1 px-1">Home</li>
    //       </Link>
    //       <Link href="/#about" prefetch={false}>
    //         <li className="mx-3 text-small uppercase hover:bg-gray-500 rounded-full py-1 px-1">About</li>
    //       </Link>
    //       <Link href="/#skill" prefetch={false}>
    //         <li className="mx-2 text-small uppercase hover:bg-gray-500 rounded-full py-1 px-1">Skills</li>
    //       </Link>
    //       <Link href="/Experience" prefetch={false}>
    //         <li className="mx-2 text-small uppercase hover:bg-gray-500 rounded-full py-1 px-1">Experience</li>
    //       </Link>
    //       <Link href="/Project" prefetch={false}>
    //         <li className="mx-2 text-small uppercase hover:bg-gray-500 rounded-full py-1 px-1">Projects</li>
    //       </Link>
    //       <Link href="/#contact" prefetch={false}>
    //         <li className="mx-2 text-small uppercase hover:bg-gray-500 rounded-full py-1 px-1">Contact</li>
    //       </Link>
    //     </ul>
    //   </div>
